...
namespace MessageQueue.DataAccess.Respositories.Messages
{
    ...
    public class MessageRepository(ApplicationContext context) : RepositoryBase<Message>(context), IMessageRepository
    {
